...
<script src="{{ asset('adminto/libs/selectize/js/standalone/selectize.min.js') }}"></script>
<script src="{{ asset('adminto/libs/mohithg-switchery/switchery.min.js') }}"></script>
<script src="{{ asset('adminto/libs/multiselect/js/jquery.multi-select.js') }}"></script>
<script src="{{ asset('adminto/libs/select2/js/select2.min.js') }}"></script>
<script src="{{ asset('adminto/libs/jquery-mockjax/jquery.mockjax.min.js') }}"></script>
<script src="{{ asset('adminto/libs/devbridge-autocomplete/jquery.autocomplete.min.js') }}"></script>
<script src="{{ asset('adminto/libs/bootstrap-touchspin/jquery.bootstrap-touchspin.min.js') }}"></script>
<script src="{{ asset('adminto/libs/bootstrap-maxlength/bootstrap-maxlength.min.js') }}"></script>

<!-- Init js-->
<!-- <script src="{{ asset('adminto/js/pages/form-advanced.init.js') }}"></script> -->
